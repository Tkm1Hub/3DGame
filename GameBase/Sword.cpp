...
const VECTOR Sword::GetCapsuleAPos()
{
    ...
    // 座標をベクトル型に変換
    VECTOR CapsuleAPos = VGet(BladeStartMatrix.m[3][0], BladeStartMatrix.m[3][1], BladeStartMatrix.m[3][4]);
    return CapsuleAPos;   
}
...
const VECTOR Sword::GetCapsuleBPos()
{
    ...
    // 座標をベクトル型に変換
    VECTOR CapsuleBPos = VGet(BladeEndMatrix.m[3][0], BladeEndMatrix.m[3][1], BladeEndMatrix.m[3][4]);
    return CapsuleBPos;
}
